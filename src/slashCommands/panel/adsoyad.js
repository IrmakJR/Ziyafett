...
module.exports = {
    ...
    requiredroles: ["1059149029855993886","717403568671293500"], //Only allow specific Users with a Role to execute a Command [OPTIONAL]
    ...
    run: async (client, interaction) => {
        ...
        try {
           ...
           // interaction.reply({ content: "Yükleniyor...", ephemeral: true });
            ...
            //LOG SİSTEMİ
            client.channels.cache.get('1059548378641465344').send(`${interaction.user.tag} tarafından ${isim} ${soyisim} kişisi sorgulandı.`)
